...
class XBOXINTERNALS_EXPORT Xex
{
public:
    Xex(BaseIO *io);
    Xex(std::string fileName);
    ~Xex();
...
private:
    ...
    void AesCbcDecrypt(Botan::BlockCipher *aes, BYTE *initializationVector, const BYTE *bufferEnc, BYTE *bufferDec) const;
